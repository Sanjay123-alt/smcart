                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card shadow-sm product-card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(url('/cart/add/' . $product->id)); ?>" class="btn btn-success" onclick="showProductAddedToast()">Add to Cart</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">Ordered : <?php echo e(\Carbon\Carbon::parse($order->created_at)->diffForHumans()); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\sanjay-personal\sanmals_cart\mycart_backend\resources\views/home/index.blade.php ENDPATH**/ ?>