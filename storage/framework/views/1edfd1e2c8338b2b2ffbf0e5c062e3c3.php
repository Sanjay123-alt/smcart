...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <div class="position-fixed top-10 end-0 m-3">
        <button id="cartIcon" class="btn btn-warning" title="Go to Cart" onclick="window.location.href='<?php echo e(url('/cart')); ?>'">
...
<?php /**PATH C:\sanjay-personal\sanmals_cart\mycart_backend\resources\views/layouts/app.blade.php ENDPATH**/ ?>